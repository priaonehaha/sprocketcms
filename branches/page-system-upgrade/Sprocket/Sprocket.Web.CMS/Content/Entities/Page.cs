...
namespace Sprocket.Web.CMS.Content
{
	public class Page: IJSONEncoder, IJSONReader, IPropertyEvaluatorExpression
	{
		...
		protected long parentPageCode = 0;
		...
		public Page(long pageID, long revisionID, string pageCode, long parentPageCode, string templateName, bool requestable, string requestPath, string contentType)
		{
			this.pageID = pageID;
		...
		public Page(IDataReader reader)
		{
			...
			if(reader["ParentPageCode"] != DBNull.Value) parentPageCode = (long)reader["ParentPageCode"];
		...
		public void LoadJSON(object json)
		{
			...
			parentPageCode = (long)values["ParentPageCode"];
