...
namespace Sprocket.Web.CMS.Content.Expressions
{
	...
	public class HostNameExpression : IExpression
	{
		public object Evaluate(ExecutionState state, Token contextToken) { return HttpContext.Current.Request.Url.Host; }
	}
	public class HostNameExpressionCreator : IExpressionCreator
	{
		public string Keyword { get { return "hostname"; } }
		public IExpression Create() { return new HostNameExpression(); }
	}
